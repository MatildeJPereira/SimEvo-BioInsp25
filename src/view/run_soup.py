# Launch the interactive Molecular Soup visualization.
# This script:
# - Loads a predefined set of SELFIES molecules (“soup”).
# - Initializes a Population and GeneticAlgorithm.
# - Runs the pygame-based molecular soup with real-time evolution.
...
# Penalized fitness + novelty component
ga = GeneticAlgorithm(cfg, lambda m: novelty_augmented_fitness(m, novelty_weight=0.5))

# Evolution callback for pygame
def evolve_callback(population):
    """Advance one generation and return the new population."""
